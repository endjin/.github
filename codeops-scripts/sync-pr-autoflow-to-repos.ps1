...
"@
        $GitVersionFile = New-Item "GitVersion.yml" -Force
        $GitVersionFileHeader | Out-File $GitVersionFile
        ConvertTo-YAML $gitVersionConfig | Out-File -Append $GitVersionFile
    }
